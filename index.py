...
def main_handler(event, context):
    ...
    xx = [
       ['13002982631','18409040213','仵西龙','WuXiLong','陕西省','西安市','莲湖区','教场门77号'],
       ['13891198746','18409040216','刘一凡','Fan','陕西省','延安市','子长市','张家沟小区'],
       ['15719269901','18409040218','陈金龙','JiangShanXiaoYanYuYao','陕西省','汉中市','城固县','张骞路春熙花苑'],
       ['18591310709','18409040215','位吉祥','varvel','陕西省','渭南市','临渭区','老城渭运小区'],
    ]
    for i in range(0,4):
        data = data9613[i]
        payloadd['xkdjkdk']['sjh2'] = xx[i][0]
        payloadd['xkdjkdk']['gh'] = xx[i][1]
        payloadd['xkdjkdk']['xm'] = xx[i][2]
        msggg = xx[i][3]
        payload = payloadd
        print(payload)
